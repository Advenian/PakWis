...
<head>
    ...
    <!-- bootstrap core css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/template/inance-html/css/bootstrap.css') }}" />
    <!-- font awesome style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/template/inance-html/css/font-awesome.min.css') }}" />

    <!-- Custom styles for this template -->
    <link href="{{ asset('/template/inance-html/css/style.css') }}" rel="stylesheet" />
    <!-- responsive style -->
    <link href="{{ asset('/template/inance-html/css/responsive.css') }}" rel="stylesheet" />
...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('service.html') }}">Services</a>
                                </li>
                                <li class="nav-item">
        ...
        <section class="slider_section ">
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="{{ asset('/template/inance-html/images/slider-img.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="feature_section">
        <div class="container">
            <div class="feature_container">
                <div class="box">
                    <div class="img-box">
                        <svg enable-background="new 0 0 511.995 511.995" height="512" viewBox="0 0 511.995 511.995"
                ...
                <div class="box active">
                    <div class="img-box">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="512" height="512">
                            <g id="paint-painted-paint_roller-home-house"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="img-box">
                        <img src="{{ asset('/template/inance-html/images/about-img.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="professional_section layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="img-box">
                        <img src="{{ asset('/template/inance-html/images/professional-img.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-6 ">
                    <div class="detail-box">
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="{{ asset('/template/inance-html/images/s1.png') }}" alt="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Maintenance
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="{{ asset('/template/inance-html/images/s2.png') }}" alt="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Electrical
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="{{ asset('/template/inance-html/images/s3.png') }}" alt="" />
                        </div>
                        <div class="detail-box">
                            <h5>
                                Plumbing
                ...
                <div class="owl-carousel">
                    <div class="item">
                        <div class="box">
                            <div class="client_id">
                                <div class="img-box">
                                    <img src="{{ asset('/template/inance-html/images/client-1.jpg') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="client_id">
                                <div class="img-box">
                                    <img src="{{ asset('/template/inance-html/images/client-2.jpg') }}"
                                        alt="">
                                </div>
                                <div class="client_detail">
                                    <div class="client_info">
    ...
    <script src="{{ asset('/template/inance-html/js/jquery-3.4.1.min.js') }}"></script>
    <script src="{{ asset('/template/inance-html/js/bootstrap.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="{{ asset('/template/inance-html/js/custom.js') }}"></script>
    <!-- Google Map -->
